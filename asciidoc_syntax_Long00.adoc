...
== AsciiDoc Syntax 9999999999999999888788
...
[%hardbreaks]
https://example.org/page[A webpage: https://example.org/page. THIS WORKS]

link:../media/AcerWinData/github_from_home/CloneOfianasciidocpreview-active-editor-info-20230915_ChromeZoomWiTransformFactorInFile/TEST_textfile.txt[A local file: Opens unknownfile (link: ../media/AcerWinData/github_from_home/CloneOfianasciidocpreview-active-editor-info-20230915_ChromeZoomWiTransformFactorInFile/TEST_textfile.txt)]

link:atom://core/open/file?filename="/home/ian/websites/atom.io_FLightManual1.57Fromatom-flight-manual-archive.github.io/atom-flight-manual-archive.github.io/index.html"[A local file atom flight manual: (link:atom://core/open/file?filename="/home/ian/websites/atom.io_FLightManual1.57Fromatom-flight-manual-archive.github.io/atom-flight-manual-archive.github.io/index.html")]

link:atom://core/open/file?filename="/media/AcerWinData/github_from_home/CloneOfianasciidocpreview-active-editor-info-20230915_ChromeZoomWiTransformFactorInFile/TEST_textfile.txt"[A local file TEST_textfile.txt wi full path: (link:atom://core/open/file?filename="/media/AcerWinData/github_from_home/CloneOfianasciidocpreview-active-editor-info-20230915_ChromeZoomWiTransformFactorInFile/TEST_textfile.txt")]

link:atom://core/open/file?filename="TEST_textfile.txt"[A local file TEST_textfile.txt wi just filename. Open unknownfile: (link:atom://core/open/file?filename="TEST_textfile.txt")]

xref:asciidoc_syntax_VShort.adoc[A sibling document: (xref:asciidoc_syntax_VShort.adoc)]

mailto:hello@example.org[Email to say hello!: (mailto:hello@example.org)]
...
xref:document.adoc#idname[Jumps to anchor in another document: xref:document.adoc#idname].
