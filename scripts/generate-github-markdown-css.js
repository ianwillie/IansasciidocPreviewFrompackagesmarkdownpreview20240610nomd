...
async function run() {
  ...
  let lightCSSAuto = lightContents.replace(/\.markdown-body\b/g, '.iansasciidoc-previewfrompackagesmarkdownpreview20240610nomd[data-use-github-style="auto"]');
  let darkCSSAuto = darkContents.replace(/\.markdown-body\b/g, '.iansasciidoc-previewfrompackagesmarkdownpreview20240610nomd[data-use-github-style="auto"]');
  ...
  let lightCSSMode = lightContents.replace(/\.markdown-body\b/g, '.iansasciidoc-previewfrompackagesmarkdownpreview20240610nomd[data-use-github-style="light"]');
  let darkCSSMode = darkContents.replace(/\.markdown-body\b/g, '.iansasciidoc-previewfrompackagesmarkdownpreview20240610nomd[data-use-github-style="dark"]');
